...
export const LinearSearch: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Draw legend
      const legends = [
        { color: "#F3F4F6", text: "Not Searched" },
        { color: "#FDE68A", text: "Current" },
        { color: "#FCA5A5", text: "Searched" },
  ...
  return (
    <Template {...algorithmData.linearSearch}>
      <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Linear Search Visualization</h2>
